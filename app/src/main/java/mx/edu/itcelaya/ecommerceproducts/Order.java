...
public class Order {
     ...
     * @param couponLines
     */
    public Order(int id, int orderNumber, String createdAt, String updatedAt, String completedAt, String status, String currency, String total, String subtotal, int totalLineItemsQuantity, String totalTax, String totalShipping, String cartTax, String shippingTax, String totalDiscount, String shippingMethods, PaymentDetails paymentDetails, BillingAddress billingAddress, ShippingAddress shippingAddress, String note, String customerIp, String customerUserAgent, int customerId, String viewOrderUrl, List<LineItem> lineItems, List<ShippingLine> shippingLines, List<TaxLine> taxLines, List<Object> feeLines, List<Object> couponLines, Customer customer) {
        this.id = id;
