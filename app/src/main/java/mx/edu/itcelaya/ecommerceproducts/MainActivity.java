...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://192.168.0.15/wordpress/wc-api/v3/orders?status=";
    String jsonResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listOrders.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                                    long id) {
                //int id_item = items.get(position);
...
//                startActivity(intent);
        ...
        dropdown.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                url = "https://192.168.0.15/wordpress/wc-api/v3/orders?status="+String.valueOf(dropdown.getSelectedItem());
                loadOrders();
            }
    ...
    public void ListProductos() {
            Gson gson = new Gson();
        Ordenes ordenes = gson.fromJson(jsonResult, Ordenes.class);
